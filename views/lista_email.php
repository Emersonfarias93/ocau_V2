...
<body>
  ...
  <?php foreach($lista as $lista_emails): ?>
    <tr>
      ...
      <td>
            <a href="/ocau_V2/config/editar.php?id=<?php echo $lista_emails['id']; ?>" class="btn btn-secondary"> Editar </a>            
        </td>
        <td><a href="/ocau_V2/config/apagar.php?id=<?php echo $lista_emails['id']; ?>" class="btn btn-danger"> Apagar </a></td>
    </tr>
  <?php endforeach; ?> 
  </tbody>
  </main>
